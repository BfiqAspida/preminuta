    ...
    public function index (Request $request){
        if($request->session()->has('user')){
            ...
            $vehicles = Vehicle::select(DB::raw('DATE(created_at) as date'), DB::raw('count(id) as vehiculos'))
                ->whereIn('Vehicles_vehicles_book.WorkStation_id_id', ['d842ea84-a431-11ee-a506-0242ac120002', '0977e274-a425-11ee-a506-0242ac120002', '5c0b11c6-8d6b-11ee-b9d1-0242ac120002'])
